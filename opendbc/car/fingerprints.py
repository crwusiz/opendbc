...
MIGRATION = {
  ...
  "HYUNDAI SONATA PE (DN8)": HYUNDAI.HYUNDAI_SONATA_DN8_PE,
  ...
  "HYUNDAI GRANDEUR PE (IG)": HYUNDAI.HYUNDAI_GRANDEUR_PE,
  "HYUNDAI GRANDEUR PE HYBRID (IG)": HYUNDAI.HYUNDAI_GRANDEUR_PE_HEV,
  ...
  "KIA K5 PE (DL3)": HYUNDAI.KIA_K5_DL3_PE,
  "KIA K5 PE HYBRID (DL3)": HYUNDAI.KIA_K5_DL3_PE_HEV,
  "KIA K7 (YG)": HYUNDAI.KIA_K7,
  "KIA K7 HYBRID (YG)": HYUNDAI.KIA_K7_HEV,
  "KIA K7 PE (YG)": HYUNDAI.KIA_K7_PE,
  "KIA K7 PE HYBRID (YG)": HYUNDAI.KIA_K7_PE_HEV,
